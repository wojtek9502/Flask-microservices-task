...
@gateman_blueprint.route("/train/barrier", methods=["GET"])
...
@gateman_blueprint.route("/train/barrier/open", methods=["PATCH"])
def open_barrier():
    barrier_obj: BarrierModel = BarrierModel.query.get(1)
...
@gateman_blueprint.route("/train/barrier/close", methods=["PATCH"])
def close_barrier():
    barrier_obj: BarrierModel = BarrierModel.query.get(1)
